...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__location__ = __webpack_require__(1054);
...
var LocationPage = /** @class */ (function () {
    function LocationPage(navCtrl, navParams, viewCtrl, http) {
        this.navCtrl = navCtrl;
     ...
     */
    LocationPage.prototype.chooseLocation = function (location) {
     ...
     * @param ev
     */
    LocationPage.prototype.getItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            this.locations = this.newLocationList.filter(function (item) {
    ...
    LocationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-location',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\location\location.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n<!-- Location Search Page  -->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-three title="Select Location"></header-three>\n</ion-header>\n\n<!-- Contents  -->\n<ion-content>\n  <!-- Location Search Input Box  -->\n  <ion-searchbar (ionInput)="getItems($event)" animated="true" placeholder="Search Location"></ion-searchbar>\n\n  <!-- List Of Locations  -->\n  <ion-list>\n    <ion-item *ngFor="let location of locations" tappable (tap)="chooseLocation(location)">\n      <h2>{{ location.name }}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\location\location.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
