...
var DealsPage = /** @class */ (function () {
    function DealsPage(navCtrl, navParams, dataProvider) {
        this.navCtrl = navCtrl;
    ...
    DealsPage.prototype.openPage = function (pagename) {
        this.navCtrl.setRoot(pagename.page);
    };
    /**
     * -----------------------------------------------------------
     * Get List of Deals
     ...
     */
    DealsPage.prototype.getDeals = function () {
        this.deals = this.dataProvider.getDeals();
    };
    DealsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-deals',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\deals\deals.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Deals"></header-one>\n</ion-header>\n<!-- End Header  -->\n\n<!-- Content  -->\n<ion-content>\n  <!-- List of Deals  -->\n  <div class="cards" *ngFor="let deal of deals" (click)="openPage(deal)">\n    <!-- Deal Image  -->\n    <ion-card class="card-one">\n      <img [src]="deal.image" imageViewer />\n    </ion-card>\n    <!-- Details of Deal  -->\n    <ion-card class="card-two">\n      <!-- Deal Name  -->\n      <div class="card-title">{{deal.name}}</div>\n      <!-- Deal Details  -->\n      <div class="card-subtitle">{{deal.details}}</div>\n    </ion-card>\n    \n  </div>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\deals\deals.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__deals__ = __webpack_require__(1042);
...
var DealsPageModule = /** @class */ (function () {
    ...
    DealsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__deals__["a" /* DealsPage */]), __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["a" /* IonicImageViewerModule */],
