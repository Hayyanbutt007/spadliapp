...
var CheckoutPage = /** @class */ (function () {
    function CheckoutPage(navCtrl, navParams, viewCtrl) {
        this.navCtrl = navCtrl;
     ...
     */
    CheckoutPage.prototype.goToPaymentPage = function () {
        this.viewCtrl.dismiss();
        this.navCtrl.setRoot('PaymentPage');
    };
    CheckoutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-checkout',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\checkout\checkout.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n<!-- Checkout Page  -->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-two title="Checkout"></header-two>\n</ion-header>\n\n<!-- Content  -->\n<ion-content>\n\n  <!-- Price Summery  -->\n  <div class="pricing">\n    <p class="title">TOTAL COST</p>\n    <p class="cost">$440</p>\n  </div>\n\n  <!-- Payment Option  -->\n  <div class="options" padding-top>\n    <ion-grid>\n      <ion-row>\n        <!-- Paypal  -->\n        <ion-col col-6>\n          <ion-row (tap)="paymentTypes = \'paypal\'" text-center>\n            <ion-col col-12>\n              <i class="fa fa-cc-paypal fa-5x" aria-hidden="true" [ngClass]="paymentTypes == \'paypal\' ? \'color2\' : \'light\'"></i>\n            </ion-col>\n            <ion-col col-12>\n              <button ion-button [color]="paymentTypes == \'paypal\' ? \'color2\' : \'color3\'">paypal</button>\n            </ion-col>\n          </ion-row>\n        </ion-col>\n\n        <!-- Card  -->\n        <ion-col col-6>\n          <ion-row (tap)="paymentTypes = \'card\'" text-center>\n            <ion-col col-12>\n              <i class="fa fa-credit-card-alt fa-5x" aria-hidden="true" [ngClass]="paymentTypes == \'card\' ? \'color2\' : \'light\'"></i>\n            </ion-col>\n            <ion-col col-12>\n              <button ion-button [color]="paymentTypes == \'card\' ? \'color2\' : \'color3\'">card</button>\n            </ion-col>\n          </ion-row>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </div>\n</ion-content>\n\n<!-- Footer  -->\n<ion-footer>\n  <button ion-button large full no-margin class="custom-btn" (tap)="goToPaymentPage()">\n    Select\n  </button>\n</ion-footer>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\checkout\checkout.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkout__ = __webpack_require__(1037);
    ...
    CheckoutPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__checkout__["a" /* CheckoutPage */]),
            ],
        })
    ], CheckoutPageModule);
