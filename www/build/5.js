...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchBusPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
...
var SearchBusPage = /** @class */ (function () {
    function SearchBusPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
     ...
     */
    SearchBusPage.prototype.getLocationOrigin = function () {
        var _this = this;
     ...
     */
    SearchBusPage.prototype.getLocationDestination = function () {
        var _this = this;
        var modal = this.modalCtrl.create('LocationPage');
        modal.onDidDismiss(function (data) {
            if (data) {
     ...
     * -------------------------------------------------------------
     */
    SearchBusPage.prototype.openCalendar = function () {
        var _this = this;
     ...
     * -------------------------------------------------------------
     */
    SearchBusPage.prototype.findBus = function () {
        var modal = this.modalCtrl.create('BusListPage');
        modal.present();
    };
    SearchBusPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-search-bus',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\bus\search-bus\search-bus.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Search Bus"></header-one>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n\n  <!-- Trip Type  -->\n  <ion-segment color="color1" no-padding [(ngModel)]="searchObjects.tripType" style="direction:ltr">\n    <ion-segment-button value="oneWay">\n      One Way\n    </ion-segment-button>\n    <ion-segment-button value="roundTrip">\n      Round Trip\n    </ion-segment-button>\n  </ion-segment>\n\n  <ion-grid no-padding>\n    <ion-list inset>\n\n      <!-- Origin Location  -->\n      <ion-item (tap)="getLocationOrigin()">\n        <ion-label>\n          <ion-icon color="color2" name="pin"></ion-icon>\n        </ion-label>\n        <ion-input type="text" placeholder="Picking Up Location" [(ngModel)]="searchObjects.originLocationName">\n        </ion-input>\n      </ion-item>\n\n      <!-- Destination Location  -->\n      <ion-item (tap)="getLocationDestination()">\n        <ion-label>\n          <ion-icon color="color2" name="pin"></ion-icon>\n        </ion-label>\n        <ion-input type="text" placeholder="Picking Off Location" [(ngModel)]="searchObjects.destinationLocationname">\n        </ion-input>\n      </ion-item>\n\n      <!-- Departure Date  -->\n      <ion-card (tap)="openCalendar()">\n        <ion-card-content>\n          <p class="date">\n            <ion-icon color="color2" name="md-calendar"></ion-icon>&nbsp; <span>{{searchObjects.departureDate | date}}</span>\n          </p>\n        </ion-card-content>\n      </ion-card>\n\n      <!-- Seats  -->\n      <ion-card>\n        <ion-row justify-content-center align-items-center>\n          <!-- Increase Seats Number  -->\n          <ion-col col-4 text-center>\n            <button ion-button clear item-end color="color1" (tap)="searchObjects.totalSeats = searchObjects.totalSeats + 1 ">\n            <ion-icon name="add-circle" style="zoom:1.5;"></ion-icon>\n          </button>\n          </ion-col>\n\n          <!-- Total Seats  -->\n          <ion-col col-4 text-center>\n            <span><b>Seats: {{searchObjects.totalSeats}} </b></span>\n          </ion-col>\n\n          <!-- Decrease Seats Number  -->\n          <ion-col col-4 text-center>\n            <button ion-button clear item-end color="color1" [disabled]="searchObjects.totalSeats == 0" (tap)="searchObjects.totalSeats = searchObjects.totalSeats - 1 ">\n            <ion-icon name="remove-circle" style="zoom:1.5;"></ion-icon>\n          </button>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n\n      <!-- Type of Bus  -->\n      <ion-item padding-left>\n        <ion-label>Bus Type</ion-label>\n        <ion-select>\n          <ion-option value="A/C">A/C</ion-option>\n          <ion-option value="Non A/C">Non A/C</ion-option>\n          <ion-option value="Executive">Executive</ion-option>\n        </ion-select>\n      </ion-item>\n\n    </ion-list>\n  </ion-grid>\n</ion-content>\n\n<!-- Footer  -->\n<ion-footer text-center>\n  <button ion-button class="custom-btn" (tap)="findBus()">Find Bus</button>\n</ion-footer>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\bus\search-bus\search-bus.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
//# sourceMappingURL=search-bus.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchBusPageModule", function() { return SearchBusPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_bus__ = __webpack_require__(1029);
...
var SearchBusPageModule = /** @class */ (function () {
    function SearchBusPageModule() {
    }
    SearchBusPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__search_bus__["a" /* SearchBusPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__search_bus__["a" /* SearchBusPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], SearchBusPageModule);
    return SearchBusPageModule;
}());

//# sourceMappingURL=search-bus.module.js.map
