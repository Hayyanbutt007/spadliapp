...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__language__ = __webpack_require__(1052);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(209);
    ...
    LanguagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */], __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], LanguagePageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(209);
/**
 * @author    ThemesBuckets <themebucketbd@gmail.com>
 * @copyright Copyright (c) 2018
...
var LanguagePage = /** @class */ (function () {
    function LanguagePage(navCtrl, navParams, http, platform, translateService) {
        this.navCtrl = navCtrl;
     ...
     */
    LanguagePage.prototype.getAllLanguages = function () {
        var _this = this;
     ...
     */
    LanguagePage.prototype.changeLanguage = function (language) {
        if (language.ID === 'ar') {
    ...
    LanguagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-language',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\language\language.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Language"></header-one>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n  <ion-list radio-group class="animated fadeIn">\n    <ion-list-header no-lines>\n      Change Language\n    </ion-list-header>\n\n    <!-- List of Languages  -->\n    <ion-item *ngFor="let language of languages; let i=index">\n      <ion-label>{{\'LANGUAGES.\' + i + \'.VALUE\' | translate}}</ion-label>\n      <ion-radio color="color1" [checked]="language.ID == \'en\'" value="{{\'LANGUAGES.\' + i + \'.VALUE\' | translate}}" (click)="changeLanguage(language)">\n      </ion-radio>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\language\language.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
