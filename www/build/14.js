...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HotelListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data__ = __webpack_require__(208);
/**
...
var HotelListPage = /** @class */ (function () {
    function HotelListPage(navCtrl, navParams, viewCtrl, modalCtrl, dataProvider) {
        this.navCtrl = navCtrl;
    ...
    /** Do any initialization */
    HotelListPage.prototype.ngOnInit = function () {
        this.getHotelList();
    };
    /**
     * -----------------------------------------------------------
     ...
     */
    HotelListPage.prototype.getHotelList = function () {
        this.hotels = this.dataProvider.getHotels();
    };
    /**
     * Open Hotel Details Page
     */
    HotelListPage.prototype.viewDetails = function (hotel) {
        this.dismiss();
     ...
     * This function dismiss the popup modal
     */
    HotelListPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    HotelListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-hotel-list',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\hotel\hotel-list\hotel-list.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n<!-- Header  -->\n<ion-header no-border>\n  <header-three title="Hotels"></header-three>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n  <div *ngIf="hotels.length > 0">\n    <!-- List of Hotels  -->\n    <ion-list no-lines no-margin *ngFor="let hotel of hotels" (tap)="viewDetails(hotel)">\n      <ion-item class="animated fadeInLeft">\n\n        <!-- Hotel Image -->\n        <ion-thumbnail item-start>\n          <img [src]="hotel.image[0]">\n        </ion-thumbnail>\n\n        <!-- Name of Hotel -->\n        <p text-wrap class="name">{{hotel.name }}</p>\n\n        <!-- Hotel Review and Type  -->\n        <p class="reviews">{{hotel.totalReviews}} Reviews | {{hotel.type}} hotel</p>\n\n        <ion-item style="background: transparent" no-padding>\n\n          <!-- Hotel Ratings  -->\n          <rating [(ngModel)]="hotel.star" readOnly="false" max="{{hotel.star}}" emptyStarIconName="ios-star-outline" halfStarIconName="star-half"\n            starIconName="ios-star" nullable="true">\n          </rating>\n\n          <!-- Price  -->\n          <ion-badge item-end>USD{{hotel.price}}</ion-badge>\n        </ion-item>\n      </ion-item>\n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\hotel\hotel-list\hotel-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hotel_list__ = __webpack_require__(1048);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_rating__ = __webpack_require__(559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__ = __webpack_require__(557);
...
var HotelListPageModule = /** @class */ (function () {
    function HotelListPageModule() {
    }
    HotelListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__hotel_list__["a" /* HotelListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__hotel_list__["a" /* HotelListPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ionic2_rating__["a" /* Ionic2RatingModule */], __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* IonicImageViewerModule */],
...
//# sourceMappingURL=hotel-list.module.js.map
