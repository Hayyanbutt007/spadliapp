...
var ContactUsPage = /** @class */ (function () {
    ...
    ContactUsPage.prototype.loadmap = function () {
        ...
        var latlng = new google.maps.LatLng(49.2882266, -123.1180008);
        // Map Styles
        var mapStyle = [
            {
                featureType: "all",
     ...
     * --------------------------------------------------------------
     */
    ContactUsPage.prototype.addMarker = function () {
        // Marker Options
     ...
     * --------------------------------------------------------------
     */
    ContactUsPage.prototype.addInfoWindow = function (marker, content) {
        var _this = this;
    ...
    ContactUsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-contact-us',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\contact-us\contact-us.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n<!-- Contact Us Page  -->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Contact Us"></header-one>\n</ion-header>\n\n<!-- Contents  -->\n<ion-content>\n\n  <!-- Google Map  -->\n  <div #map id="map"></div>\n\n  <section>\n    <!-- Company Contact Information  -->\n    <ion-card class="content">\n      <ion-list no-lines class="infos">\n\n        <!-- Address  -->\n        <ion-item text-wrap>\n          <ion-icon item-start name="pin" color="color1"></ion-icon>\n          <p>{{contactInfos.address}}</p>\n        </ion-item>\n\n        <!-- Email  -->\n        <ion-item>\n          <ion-icon name="mail" color="primary" item-start></ion-icon>\n          <p>Email</p>\n          {{contactInfos.email}}\n          <a button ion-button medium color="primary" item-end href="mailto:{{contactInfos.email}}">Send Mail</a>\n        </ion-item>\n\n        <!-- Mobile  -->\n        <ion-item>\n          <ion-icon item-start name="call" color="danger"></ion-icon>\n          <p>Mobile</p>\n          {{contactInfos.phone}}\n          <a button ion-button medium item-end color="danger" href="tel:{{contactInfos.phone}}">Call</a>\n        </ion-item>\n\n        <!-- Whatsapp  -->\n        <ion-item>\n          <ion-icon item-start name="logo-whatsapp" color="secondary"></ion-icon>\n          <p>Whatsapp</p>\n          {{contactInfos.whatsapp}}\n          <a button ion-button medium item-end color="secondary" href="whatsapp://send?text=Hello from ThemesBuckets&phone=+{{contactInfos.phone}}&abid=+{{contactInfos.phone}}">Open App</a>\n        </ion-item>\n      </ion-list>\n    </ion-card>\n\n    <!-- Contact Form  -->\n    <ion-card class="contact-form" padding-top>\n      <p class="contact-title">FEEL FREE TO DROP US A MESSAGE!</p>\n      <form novalidate>\n        <ion-row>\n          <ion-col>\n            <ion-list inset>\n              <!-- User Name -->\n              <ion-item>\n                <ion-label>\n                  <ion-icon color="color1" name="md-person"></ion-icon>\n                </ion-label>\n                <ion-input type="text" placeholder="Your Name*" id="text">\n                </ion-input>\n              </ion-item>\n\n              <!-- Email -->\n              <ion-item>\n                <ion-label>\n                  <ion-icon color="color1" name="md-mail"></ion-icon>\n                </ion-label>\n                <ion-input type="email" placeholder="Your Email*" id="email">\n                </ion-input>\n              </ion-item>\n\n              <!-- Message  -->\n              <ion-item>\n                <ion-label>\n                  <ion-icon color="color1" name="chatbubbles"></ion-icon>\n                </ion-label>\n                <ion-textarea placeholder="Your Message*" rows="3" id="Message">\n                </ion-textarea>\n              </ion-item>\n            </ion-list>\n          </ion-col>\n        </ion-row>\n\n        <!-- Button  -->\n        <ion-row>\n          <ion-col>\n            <button ion-button block round color="color1" type="submit">Send</button>\n          </ion-col>\n        </ion-row>\n      </form>\n    </ion-card>\n  </section>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\contact-us\contact-us.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contact_us__ = __webpack_require__(1038);
