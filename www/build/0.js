...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchVacationPageModule", function() { return SearchVacationPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_vacation__ = __webpack_require__(1059);
...
var SearchVacationPageModule = /** @class */ (function () {
    function SearchVacationPageModule() {
    }
    SearchVacationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__search_vacation__["a" /* SearchVacationPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__search_vacation__["a" /* SearchVacationPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], SearchVacationPageModule);
    return SearchVacationPageModule;
}());

//# sourceMappingURL=search-vacation.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchVacationPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
...
var SearchVacationPage = /** @class */ (function () {
    function SearchVacationPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
     ...
     * -------------------------------------------------------------
     */
    SearchVacationPage.prototype.openCalendar = function () {
        var _this = this;
     ...
     * -------------------------------------------------------------
     */
    SearchVacationPage.prototype.getLocationDestination = function () {
        var _this = this;
    ...
    SearchVacationPage.prototype.findVacations = function () {
        var modal = this.modalCtrl.create('HotelListPage');
        modal.present();
    };
    SearchVacationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-search-vacation',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\vacation\search-vacation\search-vacation.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Search Vacation"></header-one>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n  <ion-grid no-padding>\n    <ion-list inset>\n\n      <!-- Location  -->\n      <ion-item (tap)="getLocationDestination()">\n        <ion-label>\n          <ion-icon color="color2" name="pin"></ion-icon>\n        </ion-label>\n        <ion-input type="text" placeholder="Your Destination" [(ngModel)]="searchObjects.destinationLocationname">\n        </ion-input>\n      </ion-item>\n\n      <!-- Dates  -->\n      <ion-row class="animated zoomIn" justify-content-center align-items-center style="height: 100%">\n\n        <!-- Departure Date -->\n        <ion-col col-5 text-center>\n          <p class="title">Departure Date</p>\n          <ion-card (tap)="openCalendar()">\n            <ion-card-content>\n              <p class="date">{{searchObjects.departureDate | date: \'dd\'}}</p>\n              <p>{{searchObjects.departureDate | date: \'MMM\'}} &nbsp;{{searchObjects.departureDate | date: \'yy\'}}</p>\n            </ion-card-content>\n          </ion-card>\n        </ion-col>\n\n        <!-- Date Icon  -->\n        <ion-col col-2 text-center>\n          <ion-icon color="color2" name="ios-calendar" style="zoom:2.5;"></ion-icon>\n        </ion-col>\n\n        <!-- Return Date -->\n        <ion-col col-5 text-center>\n          <p class="title">Return Date</p>\n          <ion-card (tap)="openCalendar()">\n            <ion-card-content>\n              <p class="date">{{searchObjects.returnDate | date: \'dd\'}}</p>\n              <p>{{searchObjects.returnDate | date: \'MMM\'}} &nbsp;{{searchObjects.returnDate | date: \'yy\'}}</p>\n            </ion-card-content>\n          </ion-card>\n        </ion-col>\n      </ion-row>\n\n      <!--  Guest -->\n      <ion-card>\n        <ion-row class="animated zoomIn" justify-content-center align-items-center style="height: 100%">\n\n          <!-- Increase Guest Number  -->\n          <ion-col col-4 text-center>\n            <button ion-button clear item-end color="color1" (tap)="searchObjects.totalGuest = searchObjects.totalGuest + 1 ">\n              <ion-icon name="add-circle" style="zoom:1.5;"></ion-icon>\n            </button>\n          </ion-col>\n\n          <!-- Total Guest Number  -->\n          <ion-col col-4 text-center>\n            <span><b>Guest: {{searchObjects.totalGuest}} </b></span>\n          </ion-col>\n\n          <!-- Decrease Guest Number  -->\n          <ion-col col-4 text-center>\n            <button ion-button clear item-end color="color1" [disabled]="searchObjects.totalGuest == 0" (tap)="searchObjects.totalGuest = searchObjects.totalGuest - 1 ">\n            <ion-icon name="remove-circle" style="zoom:1.5;"></ion-icon>\n          </button>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n    </ion-list>\n  </ion-grid>\n</ion-content>\n\n<!-- Footer  -->\n<ion-footer text-center>\n  <button ion-button class="custom-btn" (tap)="findVacations()">Find Vacations</button>\n</ion-footer>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\vacation\search-vacation\search-vacation.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"]])
    ], SearchVacationPage);
    return SearchVacationPage;
}());

//# sourceMappingURL=search-vacation.js.map
