...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CruiseListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data__ = __webpack_require__(208);
/**
...
var CruiseListPage = /** @class */ (function () {
    function CruiseListPage(navCtrl, navParams, viewCtrl, modalCtrl, dataProvider) {
        this.navCtrl = navCtrl;
     ...
     */
    CruiseListPage.prototype.getCruiseList = function () {
        this.cruises = this.dataProvider.getCruiseList();
    };
    /**
     * Open Cruise Details Page
     */
    CruiseListPage.prototype.goToViewDetailsPage = function () {
        this.dismiss();
     ...
     * This function dismiss the popup modal
     */
    CruiseListPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    CruiseListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cruise-list',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\cruise\cruise-list\cruise-list.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-three title="Cruise List"></header-three>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n  <div *ngIf="cruises.length > 0">\n    <!-- List of Cruises  -->\n    <ion-list no-lines no-margin *ngFor="let cruise of cruises" (tap)="goToViewDetailsPage(cruise)">\n      <ion-item class="animated fadeInLeft">\n\n        <!-- Boat Image -->\n        <ion-thumbnail item-start>\n          <img [src]="cruise.image">\n        </ion-thumbnail>\n\n        <!-- Name of Boat -->\n        <p text-wrap class="name">{{cruise.boatName }}</p>\n        <p text-wrap>{{cruise.subname}}</p>\n\n        <!-- Price  -->\n        <ion-badge color="color2">USD{{cruise.price}}</ion-badge>\n      </ion-item>\n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\cruise\cruise-list\cruise-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
    ...
    return CruiseListPage;
}());

//# sourceMappingURL=cruise-list.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CruiseListPageModule", function() { return CruiseListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cruise_list__ = __webpack_require__(1039);
...
var CruiseListPageModule = /** @class */ (function () {
    function CruiseListPageModule() {
    }
    CruiseListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cruise_list__["a" /* CruiseListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__cruise_list__["a" /* CruiseListPage */]),
    ...
    ], CruiseListPageModule);
    return CruiseListPageModule;
}());

//# sourceMappingURL=cruise-list.module.js.map
