...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchCarPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
...
var SearchCarPage = /** @class */ (function () {
    function SearchCarPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
     ...
     * -------------------------------------------------------------
     */
    SearchCarPage.prototype.openCalendar = function () {
        var _this = this;
        ...
        myCalendar.onDidDismiss(function (date, type) {
            if (date) {
                // Set Pick Up Date
                _this.searchObjects.departureDate = date.from.string;
                // Set Pick Off Date
                _this.searchObjects.returnDate = date.to.string;
            }
        });
    };
    /**
     ...
     * -------------------------------------------------------------
     */
    SearchCarPage.prototype.getLocationOrigin = function () {
        var _this = this;
        var modal = this.modalCtrl.create('LocationPage');
        modal.onDidDismiss(function (data) {
            if (data) {
                _this.searchObjects.originLocationName = data.name;
                _this.searchObjects.originLocationAlpha3Code = data.alpha3Code;
            }
        });
        modal.present();
    };
     ...
     * -------------------------------------------------------------
     */
    SearchCarPage.prototype.getLocationDestination = function () {
        var _this = this;
        var modal = this.modalCtrl.create('LocationPage');
        modal.onDidDismiss(function (data) {
            if (data) {
                _this.searchObjects.destinationLocationname = data.name;
                _this.searchObjects.destinationLocationAlpha3Code = data.alpha3Code;
            }
        });
        modal.present();
    };
    SearchCarPage.prototype.findCar = function () {
        var modal = this.modalCtrl.create('CarTabsPage');
        modal.present();
    };
    SearchCarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-search-car',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\car\search-car\search-car.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-one title="Search Car"></header-one>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n  <ion-grid no-padding>\n\n    <!-- Locations  -->\n    <ion-row>\n      <ion-col col-12>\n        <ion-list inset>\n\n          <!-- Origin Location  -->\n          <ion-item (tap)="getLocationOrigin()">\n            <ion-label>\n              <ion-icon color="color2" name="pin"></ion-icon>\n            </ion-label>\n            <ion-input type="text" placeholder="Picking Up Location" [(ngModel)]="searchObjects.originLocationName">\n            </ion-input>\n          </ion-item>\n\n          <!-- Destination Location  -->\n          <ion-item (tap)="getLocationDestination()">\n            <ion-label>\n              <ion-icon color="color2" name="pin"></ion-icon>\n            </ion-label>\n            <ion-input type="text" placeholder="Picking Off Location" [(ngModel)]="searchObjects.destinationLocationname">\n            </ion-input>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n\n    <!-- Dates  -->\n    <ion-row class="animated zoomIn" justify-content-center align-items-center style="height: 100%">\n      <!-- Pick Up Date  -->\n      <ion-col col-5 text-center>\n        <p class="title">Pick Up Date</p>\n        <ion-card (tap)="openCalendar()">\n          <ion-card-content>\n            <p class="date">{{searchObjects.departureDate | date: \'dd\'}}</p>\n            <p>{{searchObjects.departureDate | date: \'MMM\'}} &nbsp;{{searchObjects.departureDate | date: \'yy\'}}</p>\n          </ion-card-content>\n        </ion-card>\n      </ion-col>\n\n      <!-- Date Icon  -->\n      <ion-col col-2 text-center>\n        <ion-icon color="color3" name="ios-calendar" style="zoom:2.5;"></ion-icon>\n      </ion-col>\n\n      <!-- Pick Off Date  -->\n      <ion-col col-5 text-center>\n        <p class="title">Pick Off Date</p>\n        <ion-card (tap)="openCalendar()">\n          <ion-card-content>\n            <p class="date">{{searchObjects.returnDate | date: \'dd\'}}</p>\n            <p>{{searchObjects.returnDate | date: \'MMM\'}} &nbsp;{{searchObjects.returnDate | date: \'yy\'}}</p>\n          </ion-card-content>\n        </ion-card>\n      </ion-col>\n    </ion-row>\n\n    <!-- Times  -->\n    <ion-row class="animated zoomIn" justify-content-center align-items-center style="height: 100%">\n\n      <!-- Pick Up Time  -->\n      <ion-col col-5 text-center>\n        <p class="title">Pick Up Time</p>\n        <ion-card>\n          <ion-datetime class="time" displayFormat="HH:mm A" placeholder="Pick Up Time" [(ngModel)]="myDate"></ion-datetime>\n        </ion-card>\n      </ion-col>\n\n      <!-- Time Icon  -->\n      <ion-col col-2 text-center>\n        <ion-icon color="color3" name="ios-time" style="zoom:2.5;"></ion-icon>\n      </ion-col>\n\n      <!-- Pick Off Time  -->\n      <ion-col col-5 text-center>\n        <p class="title">Drop Off Time</p>\n        <ion-card>\n          <ion-datetime class="time" displayFormat="HH:mm A" placeholder="Drop Off Time" [(ngModel)]="myDate"></ion-datetime>\n        </ion-card>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n\n<!-- Footer  -->\n<ion-footer text-center>\n  <button ion-button class="custom-btn" (tap)="findCar()">Find Car</button>\n</ion-footer>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\car\search-car\search-car.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"]])
    ], SearchCarPage);
    return SearchCarPage;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchCarPageModule", function() { return SearchCarPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_car__ = __webpack_require__(1034);
...
var SearchCarPageModule = /** @class */ (function () {
    function SearchCarPageModule() {
    }
    SearchCarPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__search_car__["a" /* SearchCarPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__search_car__["a" /* SearchCarPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], SearchCarPageModule);
    return SearchCarPageModule;
}());

//# sourceMappingURL=search-car.module.js.map
