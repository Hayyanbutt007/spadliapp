...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ActivitiesListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data__ = __webpack_require__(208);
/**
...
var ActivitiesListPage = /** @class */ (function () {
    function ActivitiesListPage(navCtrl, navParams, viewCtrl, modalCtrl, dataProvider) {
        this.navCtrl = navCtrl;
     ...
     */
    ActivitiesListPage.prototype.getActivitiesList = function () {
        this.activities = this.dataProvider.getActivities();
    };
    /**
     * Open Details Activity Page
     */
    ActivitiesListPage.prototype.goToViewDetailsPage = function () {
        this.dismiss();
     ...
     * This function dismiss the popup modal
     */
    ActivitiesListPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    ActivitiesListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-activities-list',template:/*ion-inline-start:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\activities\activities-list\activities-list.html"*/'<!-- \n  - @author    ThemesBuckets <themebucketbd@gmail.com>\n  - @copyright Copyright (c) 2018\n  - @license   Fulcrumy\n-->\n\n<!-- Header  -->\n<ion-header no-border>\n  <header-three title="Activities List"></header-three>\n</ion-header>\n\n<!-- Content  -->\n<ion-content padding>\n\n  <div *ngIf="activities.length > 0">\n\n    <!-- List of Activities  -->\n    <ion-list no-lines no-margin *ngFor="let activity of activities" (tap)="goToViewDetailsPage(activity)">\n\n      <ion-item class="animated fadeInLeft">\n\n        <!-- Image of Activity -->\n        <ion-thumbnail item-start>\n          <img [src]="activity.image">\n        </ion-thumbnail>\n\n        <!-- Name of Activity -->\n        <p text-wrap class="name">{{activity.name }}</p>\n\n        <div>\n          <!-- Location  -->\n          <span text-wrap>\n            <ion-icon name="ios-pin" color="color1"></ion-icon>\n            {{ activity.from }}\n          </span>\n\n          <!-- Time Duration  -->\n          <span text-wrap>\n            <ion-icon name="ios-time" color="color1"></ion-icon>\n            {{ activity.duration }}\n          </span>\n        </div>\n\n        <!-- Price  -->\n        <ion-badge color="color2">USD{{activity.price}}</ion-badge>\n      </ion-item>\n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\TravelApp\TravelAgency\spadliapp\src\pages\activities\activities-list\activities-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
//# sourceMappingURL=activities-list.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivitiesListPageModule", function() { return ActivitiesListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activities_list__ = __webpack_require__(1023);
...
var ActivitiesListPageModule = /** @class */ (function () {
    function ActivitiesListPageModule() {
    }
    ActivitiesListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__activities_list__["a" /* ActivitiesListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__activities_list__["a" /* ActivitiesListPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["a" /* IonicImageViewerModule */], __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], ActivitiesListPageModule);
    return ActivitiesListPageModule;
}());

//# sourceMappingURL=activities-list.module.js.map
